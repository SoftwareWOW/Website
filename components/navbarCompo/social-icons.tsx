...
export function SocialIcons() {
  return (
    <div className="flex gap-6">
      <span>
        <Link href="https://www.facebook.com/softwarewow">
          <svg
      ...
      <span>
        <Link href="https://www.youtube.com/@SoftwareWOW_">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-[#565656] duration-200 hover:stroke-white"
            width="23"
      ...
      <span>
        <Link href="https://www.instagram.com/softwarewow">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-[#565656] duration-200 hover:stroke-white"
            width="23"
      ...
      <span>
        <Link href="https://www.linkedin.com/company/softwarewow/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-[#565656] duration-200 hover:stroke-white"
            width="23"
